        ...
        <div class="row footer-content">
            ...
            <div class="col-md-2">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-link"><a href="about_us.php#contact"><i class="fa fa-angle-right"></i>&nbsp; Contact details</a></li>
                    <li class="footer-link"><a href="about_us.php#contact"><i class="fa fa-angle-right"></i>&nbsp; Contact form</a></li>
            ...
            <div class="col-md-2">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-link"><a href="about_us.php" class="hovor"><i class="fa fa-angle-right"></i>&nbsp; About us</a></li>
                    <li class="footer-link"><a href="index.php" class="hovor"><i class="fa fa-angle-right"></i>&nbsp; Home</a></li>
                </ul>
            </div>
