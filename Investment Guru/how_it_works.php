...
<body>
  ...
  <div class="container left">
    <div class="content">
      <h2>Step 1:</h2>
      <p>The login and registration process.If you are a new user, you will have to create an account to us the application.To create an account, fill in the details in the form the appears by clicking the sign up tab.
      If you are already a registered user, login into your account by entering your username and password at the login tab.</p>
    </div>
  </div>
