            ...
            <?php  if(isset($_SESSION['loggedIN']) && $_SESSION['loggedIN'] == true) { ?>
                <ul id="lg-view" class="navbar-brand navbar-settings pull-right settings-lg">
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="howitworks.php#FAQ"><i class="fa fa-cog" aria-hidden="true"></i> Settings</a></li>
                            <li><a href="settings.php"><i class="fa fa-question-circle" aria-hidden="true"></i> Help</a></li>
                            <li class="divider"></li>
                            <li><a href="login.php?logout='1'"><i class="fa fa-power-off" aria-hidden="true"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            <?php } else { ?>
