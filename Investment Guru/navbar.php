        ...
        <div class="collapse navbar-collapse" id="bs-navbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if(isset($_SESSION['loggedIN']) && $_SESSION['loggedIN'] == true) { ?>  
                    <li <?php if (basename($_SERVER['PHP_SELF']) == 'dashboard.php' || basename($_SERVER['PHP_SELF']) == 'profile.php' || basename($_SERVER['PHP_SELF']) == 'goal.php' || basename($_SERVER['PHP_SELF']) == 'invest.php' || basename($_SERVER['PHP_SELF']) == 'settings.php') echo 'class="active"' ?>><a href="dashboard.php"><i class="fa fa-home fa-icons" aria-hidden="true"></i>&nbsp;&nbsp;Home</a></li>
